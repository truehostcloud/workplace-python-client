...
class AvailablePackagesApi:
    ...
    def available_packages_list(
        ...
        _param = self._available_packages_list_serialize(
    ...
    @validate_call
    def available_packages_list_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def available_packages_list_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _available_packages_list_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/available-packages/',
