...
class AliasDisplay(BaseModel):
    """
    AliasDisplay
    """ # noqa: E501
    id: Optional[StrictInt] = None
    primary_email: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    name: Annotated[str, Field(min_length=1, strict=True, max_length=254)]
    __properties: ClassVar[List[str]] = ["id", "primary_email", "name"]
